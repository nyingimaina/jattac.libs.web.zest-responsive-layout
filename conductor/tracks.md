...
|---|---|---|---|
| `desktop-overlay` | Add Configurable Desktop Overlay | `completed` | [Plan](./tracks/desktop-overlay/plan.md) |
| `hooks-extraction` | Extract Logic into Custom Hooks | `completed` | [Plan](./tracks/hooks-extraction/plan.md) |
